...
.. raw:: html
    ...
    <div style="background: #CFFDE1" class="admonition note custom">
        ...
        <ul>
            ...
            <li>How does depth estimation using depthNet differ from traditional methods that use stereo or RGB-D cameras?</li>
        </ul>
    </div>
...
.. raw:: html
    ...
    <div style="background: #EDCAED" class="admonition note custom">
        ...
        <ul>
            We've experienced semantic segmentation and depth estimation examples earlier.
        </ul>
            Let's ask ChatGPT about recent advancements in the field of semantic segmentation and depth estimation.
        </ul>
    </div>
